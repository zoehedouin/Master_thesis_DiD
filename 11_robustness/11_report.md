...
>
> *Note : les anciennes tables de robustesse de mesure IPD (paliers A/B/C, grilles)
> sont du legacy (ex-`09_estimations_robustesse_completes.R`) et sont archivées dans
> [`../_archive/output_legacy/Tables/Robustness_ipd/`](../_archive/output_legacy/Tables/Robustness_ipd/) —
> elles ne sont pas produites par cette partie.*
...
- **Triangulation PPML vs logs** : table côte à côte (signes, ordres de grandeur).
- **Hétérogénéité par sender** (USA/CAN stricts, JPN/GBR indulgents ; intra-UE).
